...
export default function SiteFooter(){return <footer className="global-footer"><div className="global-shell footer-grid">
  ...
  <div><strong>Institucional</strong><Link href="/seguro-automovel/blog/">Blog</Link><Link href="/politica-de-privacidade/">Privacidade</Link><Link href="/termos-de-uso/">Termos de Uso</Link><span>Monsenhor Paulo, MG</span><span>SUSEP {susep}</span></div>
