...
function CTA({children="Fazer minha cotação",light=false}) {
  ...
  return <main>
    ...
    <section className="hero" id="inicio">
      <picture className="hero-media" aria-hidden="true">
        <source media="(max-width: 640px)" srcSet="/hero-vital-frota-mobile-v33.png?v=33"/>
        <img className="hero-background" src="/hero-vital-frota-desktop-v33.png?v=33" alt=""/>
      </picture>
